...
function goHome(){document.querySelector(".game-grid")?.classList.remove("tray-layout");feedbackBoxEl.classList.remove("tray-feedback");showScreen("home");clearFeedback()}
